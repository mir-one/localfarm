...
func TestCreateInventorySeed(t *testing.T) {
	...
	material1, err2 := CreateMaterial("Bayam Lu Hsieh", "12", MoneyRUB, mts, 20, MaterialUnitPackets, nil, nil, nil)
	...
	material2, err2 := CreateMaterial("Green Disinfectant", "5", MoneyRUB, mta, 5, MaterialUnitPackets, nil, nil, nil)
	...
	material3, err2 := CreateMaterial("Soft Indoor Tray Pack", "10", MoneyRUB, mtsc, 10, MaterialUnitPieces, nil, nil, nil)
	...
	material4, err1 := CreateMaterial("Organic Super Soil", "2", MoneyRUB, mtgm, 5, MaterialUnitBags, nil, nil, nil)
	...
	material5, err1 := CreateMaterial("Clean Label", "5", MoneyRUB, mtl, 5, MaterialUnitPieces, nil, nil, nil)
	...
	material6, err1 := CreateMaterial("Warm Solid Plastic", "5", MoneyRUB, mtph, 5, MaterialUnitPieces, nil, nil, nil)
	...
	material7, err1 := CreateMaterial("Night Lamp Bright", "3", MoneyRUB, mto, 3, MaterialUnitPieces, nil, nil, nil)

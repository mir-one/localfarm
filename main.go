...
import (
	...
	assetsserver "github.com/mir-one/localfarm/src/assets/server"
	assetsstorage "github.com/mir-one/localfarm/src/assets/storage"
	growthserver "github.com/mir-one/localfarm/src/growth/server"
	growthstorage "github.com/mir-one/localfarm/src/growth/storage"
	locationserver "github.com/mir-one/localfarm/src/location/server"
	tasksserver "github.com/mir-one/localfarm/src/tasks/server"
	taskstorage "github.com/mir-one/localfarm/src/tasks/storage"
	userserver "github.com/mir-one/localfarm/src/user/server"
